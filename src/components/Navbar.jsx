...
const Navbar = ({activePage,handleNavClick, isNavbarOpen, toggleNavbar}) => {
  return (
    <>
        <div className={`2xl:w-80 xl:w-52 w-44 h-full bg-purple-100 flex flex-col 
           ...
           isNavbarOpen ? 'translate-x-0' : '-translate-x-110 md:-translate-x-0'}`}>
            <a href="#" className='2xl:text-2xl xl:text-xl font-light text-red-600 mb-14 
            tracking-wider'>
                Apple Products
            </a>
            <div className='flex flex-col flex-grow'>
                {navItems.map((item,index)=>(
                    ...
                    key={index}
                    href='#'
                    className='xl:w-36 lg:w-32 w-30 flex items-center justify-between my-3.5
            ...
            <div className='flex justify-between pr-6 pb-2'>
                ...
                <a href="+254743717554">
                    <i className='bx bxl-whatsapp text-2xl text-red-600'></i>
                </a>
            </div>
        </div>
        <button className='fixed md:hidden bottom-4 left-4 p-2 text-4xl  text-blue-400 z-30'
